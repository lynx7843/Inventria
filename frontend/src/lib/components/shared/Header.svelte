...
<style>
  ...
  .icon-btn { background: none; border: none; font-size: 1.2rem; cursor: pointer; color: #64748b; }
  .user-profile { display: flex; align-items: center; gap: 0.75rem; border-left: 1px solid #e2e8f0; padding-left: 1.5rem; }
