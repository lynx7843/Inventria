<script lang="ts">
	...
	const role = getRole();
	const dashboardHref = role ? homeFor(role) : resolve('/');
...
<aside class="sidebar">
	...
	<nav class="nav-links">
		...
		{/if}
		<a href={resolve('/settings')} class:active={activePage === 'Settings'}>Settings</a>
	</nav>
	...
	<div class="sidebar-footer">
		...
		<a class="btn-new" href={resolve('/inventory?new=1')}>+ New Entry</a>
